...
@implementation CRIMPublicUserInfo

@end

@implementation CRIMBlackInfo

@end

@implementation CRIMFriendInfo

@end

@implementation CRIMSearchFriendsInfo

@end

@implementation CRIMFullUserInfo
...
- (CRIMGender)gender {
    CRIMGender gender = CRIMGenderMale;
