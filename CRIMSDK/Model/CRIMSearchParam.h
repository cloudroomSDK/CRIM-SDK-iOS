...
@interface CRIMSearchParam : NSObject
...
// 查询群使用
@interface CRIMSearchGroupParam : NSObject
...
// 查询好友使用
@interface CRIMSearchFriendsParam : NSObject
...
// 查询聊天记录使用
@interface CRIMGetMessageOptions : NSObject
...
@interface CRIMGetAdvancedHistoryMessageListParam : CRIMGetMessageOptions
...
@interface CRIMFindMessageListParam : NSObject
...
// 查询组织架构使用
@interface CRIMSearchOrganizationParam : NSObject
...
// 查询群成员使用
@interface CRIMSearchGroupMembersParam : NSObject
